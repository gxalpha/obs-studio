...
GenericRow *PropertiesView::createProperty(obs_property_t *prop)
{
	...
	case OBS_PROPERTY_INVALID:
		row = createPropertyInvalid(prop, "Property has type OBS_PROPERTY_INVALID.");
		break;
	...
	case OBS_PROPERTY_PATH:
		//row = createPropertyPath(prop); // TODO: Implement.
		row = createPropertyInvalid(prop, "Property type 'OBS_PROPERTY_PATH' is not yet implemented.");
		break;
	case OBS_PROPERTY_LIST:
		row = createPropertyList(prop);
		break;
	case OBS_PROPERTY_COLOR:
		//row = createPropertyColor(prop); // TODO: Implement.
		row = createPropertyInvalid(prop, "Property type 'OBS_PROPERTY_COLOR' is not yet implemented.");
		break;
	case OBS_PROPERTY_BUTTON:
		row = createPropertyButton(prop);
		break;
	case OBS_PROPERTY_FONT:
		//row = createPropertyFont(prop); // TODO: Implement.
		row = createPropertyInvalid(prop, "Property type 'OBS_PROPERTY_FONT' is not yet implemented.");
		break;
	case OBS_PROPERTY_EDITABLE_LIST:
		//row = createPropertyEditableList(prop); // TODO: Implement.
		row = createPropertyInvalid(prop, "Property type 'OBS_PROPERTY_EDITABLE_LIST' is not yet implemented.");
		break;
	case OBS_PROPERTY_FRAME_RATE:
		//row = createPropertyFrameRate(prop); // TODO: Implement.
		row = createPropertyInvalid(prop, "Property type 'OBS_PROPERTY_FRAME_RATE' is not yet implemented.");
		break;
	case OBS_PROPERTY_GROUP:
		row = createPropertyGroup(prop);
		break;
	case OBS_PROPERTY_COLOR_ALPHA:
		//row = createPropertyColorAlpha(prop); // TODO: Implement.
		row = createPropertyInvalid(prop, "Property type 'OBS_PROPERTY_COLOR_ALPHA' is not yet implemented.");
		break;
	default:
		DStr str;
		dstr_printf(str, "Property type of index '%d' is unknown.", obs_property_get_type(prop));
		row = createPropertyInvalid(prop, str->array);
		break;
	}
