...
Row *PropertiesView::createPropertyList(obs_property_t *prop)
{
	...
	if (type == OBS_COMBO_TYPE_EDITABLE) {
		// TODO: add.
		return createPropertyInvalid(prop, "Subtype 'OBS_COMBO_TYPE_EDITABLE' is not yet implemented.");
	}

	if (type == OBS_COMBO_TYPE_RADIO) {
		// TODO: add.
		return createPropertyInvalid(prop, "Subtype 'OBS_COMBO_TYPE_RADIO' is not yet implemented.");
	}
	...
	connect(comboBox, &QComboBox::currentIndexChanged, this, [this, comboBox, prop]() {
		...
		case OBS_COMBO_FORMAT_INT: {
			...
			controlChanged(prop, static_cast<int>(value));
			break;
		}
		case OBS_COMBO_FORMAT_FLOAT: {
